...
const request_1 = async (urlObject, method, headers, cookies, authorization, body, files, commonHeaders) => {
...
const main = async () => {
	...
	const url_1 = {"parameters": {"test": "true"}, "path": "/api/test", "protocol": "http", "domain": "localhost", "port": 3001};
	const result = await request_1(url_1, method_1, headers_1, undefined, undefined, undefined, undefined, commonHeaders);
